...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 59.0, 189.0, 67.0, 22.0 ],
					"text" : "unpack 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 99.0, 239.0, 30.0, 22.0 ],
					"text" : "* 64"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 84.0, 269.0, 49.0, 22.0 ],
					"text" : "noteout"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 59.0, 135.0, 58.0, 22.0 ],
					"text" : "route key"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 215.0, 104.0, 29.5, 22.0 ],
					"text" : "- 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 325.0, 104.0, 101.0, 22.0 ],
					"text" : "prepend livetrack"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 325.0, 75.0, 82.0, 22.0 ],
					"text" : "route settrack"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 215.0, 135.0, 101.0, 22.0 ],
					"text" : "prepend thistrack"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 215.0, 75.0, 83.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 137.0, 29.0, 50.0, 22.0 ],
					"text" : "compile"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 59.0, 75.0, 123.0, 22.0 ],
					"viewvisibility" : 1
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "grid-js.maxpat",
				"bootpath" : "~/Documents/code/refrain",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
